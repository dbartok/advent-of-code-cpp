...
int main()
{
    ...
    std::cout << "First part: " << CurrentDay::numBlockTilesWhenGameExits(intcodeProgram) << std::endl;
    std::cout << "Second part: " << CurrentDay::scoreAfterLastBlockBroken(intcodeProgram) << std::endl;
}
