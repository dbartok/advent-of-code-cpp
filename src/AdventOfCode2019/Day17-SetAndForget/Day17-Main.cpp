...
int main()
{
    ...
    std::cout << "First part: " << CurrentDay::sumOfAlignmentParameters(intcodeProgram) << std::endl;
    std::cout << "Second part: " << CurrentDay::dustCollectedByRobot(intcodeProgram) << std::endl;
}
