...
int main()
{
    ...
    std::cout << "First part: " << CurrentDay::highestPossibleSignalSent(intcodeProgram) << std::endl;
    std::cout << "Second part: " << CurrentDay::highestPossibleSignalSentWithAmplification(intcodeProgram) << std::endl;
}
